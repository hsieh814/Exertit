...
- (void) prepareForSegue: (UIStoryboardSegue *) segue sender: (id) sender
{
    ...
    if ( [segue isKindOfClass: [SWRevealViewControllerSegue class]] ) {
        ...
        swSegue.performBlock = ^(SWRevealViewControllerSegue* rvc_segue, UIViewController* svc, UIViewController* dvc) {
            ...
            if ([[segue identifier] isEqualToString:@"AllExercises"]) {
                AllExercisesTableViewController *allExercisesTableViewController = (AllExercisesTableViewController *)dvc;
                allExercisesTableViewController.managedObjectContext = self.managedObjectContext;
            } else if ([[segue identifier] isEqualToString:@"AllWorkouts"]) {
                AllWorkoutsTableViewController *allWorkoutsTableViewController = (AllWorkoutsTableViewController *)dvc;
                allWorkoutsTableViewController.managedObjectContext  = self.managedObjectContext;
            }
        };
